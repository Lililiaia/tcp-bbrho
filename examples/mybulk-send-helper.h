...
#ifndef my_BULK_SEND_HELPER_H
#define my_BULK_SEND_HELPER_H
 ...
 * on a set of nodes.
 */
class MyBulkSendHelper
{
public:
  /**
   * Create an MyBulkSendHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  MyBulkSendHelper (std::string protocol, Address address);
