...
#ifndef MY__BULK_SEND_APPLICATION_H
#define MY_BULK_SEND_APPLICATION_H
 ...
 * \defgroup bulksend MyBulkSendApplication
 *
 ...
 */
class MyBulkSendApplication : public Application
{
public:
  /**
  ...
  MyBulkSendApplication ();

  virtual ~MyBulkSendApplication ();
